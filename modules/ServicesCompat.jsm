 ...
 *                * Striped down /w Gecko 1.9.1 XPCOMUtils compatibility
 *
...
if(!XPCOMUtils.defineLazyGetter) {
  XPCOMUtils.defineLazyGetter = function XPCU_defineLazyGetter(
                                  aObject, aName, aLambda)
  {
  ...
  XPCOMUtils.defineLazyServiceGetter = function XPCU_defineLazyServiceGetter(
                                         aObject, aName, aContract, aInterfaceName)
  {
